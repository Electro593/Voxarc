...
#define GAME__ASSET__FUNCS \
    FUNC(s32,  Glyph_IsUnicodeControl, u32 Codepoint) \
    FUNC(msdf, MSDF_Init,              void) \
    FUNC(void, MSDF_LoadFont,          msdf *MSDF) \
    FUNC(void, MSDF_GenGlyph,          u32 Codepoint) \
    FUNC(void, MSDF_Print,             msdf *MSDF) \
    FUNC(void, MSDF_Free,              msdf *MSDF) \
