...
internal m4x4r32
M4x4r32_Mul_4x4(m4x4r32 A,
                m4x4r32 B)
{
    m4x4r32 Result;
    
#if 1 //NOTE: Untested
    Result.V[0] = M4x4r32_Mul_4(A, B.V[0]);
    Result.V[1] = M4x4r32_Mul_4(A, B.V[1]);
    Result.V[2] = M4x4r32_Mul_4(A, B.V[2]);
    Result.V[3] = M4x4r32_Mul_4(A, B.V[3]);
#else
