...
internal void
Win32_InitFunctions(platform_exports *PlatformCallbacks)
{
...
Win32_InitOpenGLFunctions(platform_exports *PlatformCallbacks, win32_device_context DeviceContext)
{
...
Win32_LoadGameDll(win32_dll *GameDll,
                  platform_exports *PlatformCallbacks,
