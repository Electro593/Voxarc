...
main()
{
	...
	Material = material(
		vec3(
			float((Mat0 >> 0) & 0xFF) / 255.0,
			float((Mat0 >> 8) & 0xFF) / 255.0,
			float((Mat0 >> 16) & 0xFF) / 255.0
		),
		vec3(
			float((Mat0 >> 24) & 0xFF) / 255.0,
			float((Mat1 >> 0) & 0xFF) / 255.0,
			float((Mat1 >> 8) & 0xFF) / 255.0
		),
		vec3(
			float((Mat1 >> 16) & 0xFF) / 255.0,
			float((Mat1 >> 24) & 0xFF) / 255.0,
			float((Mat2 >> 0) & 0xFF) / 255.0
		),
		float(1 << ((Mat2 >> 8) & 0xFF))
	);
